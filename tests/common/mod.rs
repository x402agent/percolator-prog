...
pub const SLAB_LEN: usize = 1484624; // MAX_ACCOUNTS=2048 (v12.15 Account with reserve cohort queues, fits 10MB Solana limit)
...
impl TestEnv {
    ...
    pub fn read_account_capital(&self, idx: u16) -> u128 {
        ...
        pub const ACCOUNTS_OFFSET: usize = 472 + 9432;
    ...
    pub fn read_account_position(&self, idx: u16) -> i128 {
        ...
        pub const ACCOUNTS_OFFSET: usize = ENGINE + 9432;
        pub const ACCOUNT_SIZE: usize = 352;
...
impl TestEnv {
    ...
    pub fn read_account_fee_credits(&self, idx: u16) -> i128 {
        let slab_data = self.svm.get_account(&self.slab).unwrap().data;
        const ACCOUNTS_OFFSET: usize = 472 + 9432;
